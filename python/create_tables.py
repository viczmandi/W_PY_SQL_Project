...
# # getting sql insertions
# file = open("../sql/02_hr_db_table_creations_and_data_inserts.sql","r")
...
# import mysql.connector
#
# database = mysql.connector.connect(user="root", password="", host="localhost", database='hr_db')
